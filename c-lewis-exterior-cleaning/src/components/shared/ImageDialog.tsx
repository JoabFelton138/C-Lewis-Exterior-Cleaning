    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-fit max-h-screen sm:max-h-[98vh] w-auto h-auto flex flex-col bg-white rounded-lg">
                <div className="flex-1 min-h-0 p-1 sm:p-2 flex items-center justify-center overflow-hidden">
                    <img 
                        src={imageUrl} 
                        alt={altText} 
                ...
                <div className="border-t border-gray-200 p-2 sm:p-3 lg:p-4 flex-shrink-0 text-center bg-gray-50/50 backdrop-blur-sm">
                    <DialogTitle className="text-base sm:text-lg lg:text-xl text-gray-800 mb-2 title-style">{title}</DialogTitle>
